...
M.GAME_BRNN_SHOW_MENU = getUID() -- 弹出百人场菜单
M.GAME_BRNN_HIDE_MENU = getUID() -- 隐藏百人场菜单
M.GAME_BRNN_EXIT_EVENT = getUID() -- 菜单点击退出按钮
M.GAME_REFRESH_ADDBTN = getUID()
M.BR_SEATUP_REQ = getUID()--百人场请求站起
M.BR_NET_SIT_UP_EVT = getUID() --百人场坐下通知
M.NET_BR_BULL_INPUT_REQ = getUID() --登陆进桌
M.ENTERGAMECLICK = getUID()	--直接进桌
