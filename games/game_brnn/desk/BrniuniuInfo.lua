local BrniuniuInfo = class("BrniuniuInfo")

BrniuniuInfo.TAG = "BrniuniuInfo"

function BrniuniuInfo:updateHistory(m)
    self.history = {}
...
function BrniuniuInfo:getHistoryBySection(section)
    local history = {}
...
function BrniuniuInfo:updateOthers(m)
...
function BrniuniuInfo:updateDelarList(m)
    self.delars = {}
...
function BrniuniuInfo:_updateProps( propsTable , src,dest )
